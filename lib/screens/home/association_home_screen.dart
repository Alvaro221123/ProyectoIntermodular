...
// ----------------------------------------------------------------------------
// Pantalla principal del perfil de asociación.
//
// Responsabilidades:
// - Cargar el perfil del usuario autenticado.
// - Permitir crear, consultar, editar estado y eliminar alertas propias de la asociación.
...
class AssociationHomeScreen extends StatefulWidget {
  const AssociationHomeScreen({super.key});
...
// Usamos estos colores para unificar visualmente todo el panel asociación.
